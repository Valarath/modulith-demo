package com.example._4_2.order.service
...
import com.example._4_2.order.repository.OrderRepository
import com.example._4_2.payment.FindPaymentOrder
import com.example._4_2.payment.OrderPayment
...
class OrderService(
    ...
    fun findById(findPaymentOrder: FindPaymentOrder) = orderRepository.findById(findPaymentOrder.orderId)
        .also { publisher.publishEvent(OrderPayment(it.customerId,it.id,findPaymentOrder.amount)) }
